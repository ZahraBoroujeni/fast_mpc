...
#define S_FUNCTION_NAME myMPC_FORCESPro_simulinkBlockcompact
...
typedef myMPC_FORCESProINTERFACE_FLOAT myMPC_FORCESProNMPC_FLOAT;
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Copy inputs */
	for( i=0; i<2; i++){ params.minusA_times_x0[i] = (double) minusA_times_x0[i]; }
