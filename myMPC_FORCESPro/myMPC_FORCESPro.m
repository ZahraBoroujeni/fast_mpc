% myMPC_FORCESPro - a fast interior point code generated by FORCES
%
%   OUTPUT = myMPC_FORCESPro(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = myMPC_FORCESPro(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = myMPC_FORCESPro(PARAMS) returns 
